  ...
  return (
    <View className="flex-1 bg-brand-dark items-center justify-center px-6">
      <View className="items-center mb-12">
        <Coffee size={64} color="#A16B3D" className="mb-4" />
      ...
      <View className="w-full flex-col space-y-4 gap-4">
        ...
        >
          <ChefHat size={24} color="#2A2A2A" />
          <Text className="text-brand-dark font-bold text-lg ml-3">
            Masuk Dapur (KDS)
          </Text>
        </TouchableOpacity>
